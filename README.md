...
```javascript
drev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-drev@v0.0.11-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var drev = require( 'path/to/vendor/umd/blas-ext-base-drev/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-drev@v0.0.11-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-drev/actions/workflows/test.yml/badge.svg?branch=v0.0.11
[test-url]: https://github.com/stdlib-js/blas-ext-base-drev/actions/workflows/test.yml?query=branch:v0.0.11
