...
var drev = tryRequire( resolve( __dirname, './../lib/drev.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( drev.length, 3, 'returns expected value' );
	t.end();
});

tape( 'the function reverses a strided array', opts, function test( t ) {
	var expected;
	var x;
...
tape( 'if `stride` is equal to `1`, the function efficiently reverses a strided array', opts, function test( t ) {
	var expected;
	var x;
	var i;
